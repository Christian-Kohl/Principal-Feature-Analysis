...
# Just to note, this code has been modified from the original by the authors
...
def pfa(data_loc, from_csv=False, number_output_functions=1, number_sweeps=1, cluster_size=50, alpha=0.01, min_n_datapoints_a_bin=500, shuffle_feature_numbers=0, frac=1, calculate_mutual_information=0, basis_log_mutual_information=2):
    ...
    for i in list_pf_ds:
        ...
        list_principal_features_depending_on_system_state_for_intersection.append(
            intermediate_list)
